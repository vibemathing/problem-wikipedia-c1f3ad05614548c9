...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:wikipedia-c1f3ad05614548c9",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-c1f3ad05614548c9",
    ...
    "statement": {
      "language": "en",
      "text": "Köthe conjecture : if a ring has no nil ideal other than $\\{0\\}$ , then it has no nil one-sided ideal other than $\\{0\\}$ .",
      "version": 1
    },
    "title": "Köthe conjecture",
    "updated_at": "2026-09-08T11:09:27Z"
  },
  "problem_contract_sha256": "b2bfa7c0307d80cc2e6707f57ba51feac08a6df7df831a0735349eac57cc1441"
}
```
